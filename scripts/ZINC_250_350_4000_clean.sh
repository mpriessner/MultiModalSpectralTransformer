#!/bin/bash
#SBATCH --job-name=script_ZINC_250_350_4000
...
#SBATCH --output=/projects/cc/knlr326/1_NMR_project/2_Notebooks/MultiModalTransformer/scripts/script_ZINC_250_350_4000.txt
