...
def main():
    ...
    config.SGNN_csv_gen_smi = os.path.join(project_root, "data/PubChem_dataset/val_data_250_350_x1000/ML_NMR_2M_XL_1H_V1_test_f_250_350_x1000.csv")
    config.pkl_save_folder = os.path.join(project_root, "experiments/baseline_PC_ZINC/PC_250_350")
